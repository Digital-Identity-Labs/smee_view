defmodule SmeeView.Networks do
  ...
  @moduledoc """
  This module can extracts the `<mdui:IPHint>` elements in entity metadata as "aspect" structs, and then
  ...
  * There is also `view_one/3` which returns the first aspect found
  ...
  @entity_xmap [
    ~x"//md:IDPSSODescriptor/md:Extensions/mdui:DiscoHints/mdui:IPHint"le,
    network: ~x"./text()"s
  ]
