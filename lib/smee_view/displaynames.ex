defmodule SmeeView.Displaynames do
  ...
  @moduledoc """
  This module can extracts the `<mdui:Displayname>` elements in entity metadata as "aspect" structs, and then
  ...
  * There is also `view_one/2` which returns the first aspect of one entity
  ...
  use SmeeView.ViewCommon, aspect: SmeeView.Aspects.Displayname, roles: true, features: [:lang, :text]
